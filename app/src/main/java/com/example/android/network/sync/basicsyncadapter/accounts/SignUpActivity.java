...
import static com.example.android.network.sync.basicsyncadapter.accounts.AccountGeneral.sServerAuthenticate;
import static com.example.android.network.sync.basicsyncadapter.accounts.AuthenticatorActivity.ARG_ACCOUNT_TYPE;
import static com.example.android.network.sync.basicsyncadapter.accounts.AuthenticatorActivity.KEY_ERROR_MESSAGE;
import static com.example.android.network.sync.basicsyncadapter.accounts.AuthenticatorActivity.PARAM_USER_PASS;
